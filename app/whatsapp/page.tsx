...
export default function WhatsAppPage() {
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,_#effcf6_0%,_#ffffff_35%,_#f8fafc_100%)] text-slate-900">
      <section className="px-6 py-20">
        <div className="mx-auto max-w-5xl rounded-[2.5rem] border border-emerald-100 bg-white px-8 py-14 shadow-[0_24px_80px_rgba(15,23,42,0.08)] md:px-14">
          <div className="mb-6 inline-flex rounded-full bg-emerald-100 px-4 py-2 text-xs font-semibold tracking-[0.24em] uppercase text-emerald-900">
            WhatsApp
          </div>
